...
[![Health Check](https://img.shields.io/github/actions/workflow/status/hardytool/server/health-check.yml?logo=github&label=health%20check)](https://github.com/hardytool/server/actions/workflows/health-check.yml?query=branch%3Atrunk "View health check status")
